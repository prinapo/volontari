...
test.describe('Admin Page', () => {
  ...
  test('AD-01: Pagina admin caricata @smoke', async ({ page }) => {
    await expect(page.locator('.admin-page')).toBeVisible({ timeout: 10_000 })
  })
  ...
  test('ADU-01: Tabella utenti si carica con colonne @smoke', async ({ page }) => {
    await expect(page.locator('.text-h5:has-text("Admin")')).toBeVisible({ timeout: 15_000 })
...
test.describe('Admin — Associazioni CRUD', () => {
  ...
  test('ADA-03: Crea associazione con Nome e Budget @crud', async ({ page }) => {
    ...
    await expect(page.locator('.q-dialog:visible')).not.toBeVisible({ timeout: 15_000 })
...
test.describe('Admin — Impersonazione', () => {
  ...
  test('AD-IMP-01: Pulsante Impersona visibile su utenti @smoke', async ({ page }) => {
    ...
    await page.goto('/admin')
    await page.waitForLoadState('networkidle').catch(() => {})
    await expect(page.locator('button[aria-label="Impersona utente"]').first()).toBeVisible({ timeout: 10_000 })
  })
  ...
  test('AD-IMP-02: Impersona utente e torna a admin @crud', async ({ page }) => {
    ...
    await Promise.all([page.waitForLoadState('domcontentloaded', { timeout: 20_000 }).catch(() => {}), impBtn.click()])
    await page.waitForLoadState('networkidle').catch(() => {})
    ...
    await page.goto('/admin', { timeout: 15_000 }).catch(() => {})
    await page.waitForLoadState('networkidle').catch(() => {})
    ...
    await expect(page.locator('.admin-page')).toBeVisible({ timeout: 15_000 })
  ...
  test('AD-CHECK-01: Tab Check mostra verifica consistenza @smoke', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle').catch(() => {})
    await expect(page.locator('.q-banner').first()).toBeVisible({ timeout: 15_000 })
  })

  test('AD-CHECK-02: Tab Check mostra sezione controllo @smoke', async ({ page }) => {
    await loginAs(page, 'admin', auth)
    await page.goto('/admin')
    await page.locator('.q-tab:has-text("Check")').click()
