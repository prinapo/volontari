...
- Calcolo `erogabile` nelle proposte di pagamento ora applica 80% del rendicontato
- Ordinamento proposte pagamenti: ascendente per DataProposta (più vecchie prima)
