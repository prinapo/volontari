    ...
    <q-card>
      <q-card-section class="row items-center">
        <div>
          ...
          <div class="text-body2 text-grey-7">{{ progetto.beneficiario }} — Anno {{ progetto.annoBando }}</div>
...
aria-label="Chiudi">
      ...
      <q-card-section>
        <div class="text-subtitle2 text-grey-8 q-mb-sm">Dati progetto</div>
      ...
      <q-card-section v-if="progetto.descrizioneProgetto || progetto.descrizioneCondizione || progetto.dettaglioCosti">
        <div class="text-subtitle2 text-grey-8 q-mb-sm">Descrizioni</div>
      ...
      <q-card-section
        v-if="
          progetto.allegatiProgetto?.length || progetto.allegatiISEE?.length || progetto.allegatiGiustificativi?.length
        "
      >
        <div class="text-subtitle2 text-grey-8 q-mb-sm">Allegati</div>
      ...
      <q-card-section>
        <div class="text-subtitle2 text-grey-8 q-mb-sm">Dati finanziari</div>
      ...
      <q-card-section>
        <div class="text-subtitle2 text-grey-8 q-mb-sm">Dati bancari</div>
        <div class="row q-col-gutter-md">
