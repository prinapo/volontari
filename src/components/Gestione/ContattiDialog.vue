      ...
      <q-card-section>
                ...
                <q-card-section class="q-pa-sm">
                  ...
                  <div class="text-caption q-mt-xs">
                    <template v-for="em in slotPropsV.row._emails" :key="em.email_address">
                      <q-icon name="email" size="xs" class="q-mr-xs text-grey-6" /><a
                        :href="'mailto:' + em.email_address"
                        class="text-primary"
                        >{{ em.email_address }}</a
                      >
                  ...
                  <div class="text-caption text-grey-7">
                    <template v-if="slotPropsV.row.Contatto?.Numero_di_cellulare">
                      <a :href="'tel:' + slotPropsV.row.Contatto?.Numero_di_cellulare" class="text-primary">{{
                        slotPropsV.row.Contatto?.Numero_di_cellulare
                      }}</a> </template
                    ><template v-if="slotPropsV.row.Contatto?.Numero_di_telefono">
                      <a :href="'tel:' + slotPropsV.row.Contatto?.Numero_di_telefono" class="text-primary">{{
                        slotPropsV.row.Contatto?.Numero_di_telefono
                      }}</a>
                    </template>
                  </div>
        ...
        >
                ...
                <q-card-section class="q-pa-sm">
                  ...
                  <div class="text-caption text-grey-7">
                    <template v-if="slotPropsG.row.Contatto?.Numero_di_cellulare">
                      <a :href="'tel:' + slotPropsG.row.Contatto?.Numero_di_cellulare" class="text-primary">{{
                        slotPropsG.row.Contatto?.Numero_di_cellulare
                      }}</a> </template
                    ><template v-if="slotPropsG.row.Contatto?.Numero_di_telefono">
                      <a :href="'tel:' + slotPropsG.row.Contatto?.Numero_di_telefono" class="text-primary">{{
                        slotPropsG.row.Contatto?.Numero_di_telefono
                      }}</a>
                    </template>
                  </div>
                  <div class="row q-mt-sm justify-end">
                    <q-btn flat dense icon="delete" color="negative" size="sm" @click="handleRemove(slotPropsG.row)">
                      <q-tooltip>Rimuovi</q-tooltip>
                    </q-btn>
                  </div>
                </q-card-section>
          ...
          <template #body-cell-azioni="slotPropsG">
            <q-td :props="slotPropsG">
              <q-btn flat dense icon="delete" color="negative" @click="handleRemove(slotPropsG.row)">
                <q-tooltip>Rimuovi</q-tooltip>
              </q-btn>
            </q-td>
          </template>
