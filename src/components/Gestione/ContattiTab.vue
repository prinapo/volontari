  ...
  <div>
    ...
    >
                ...
                <div class="row q-col-gutter-sm">
                  <div class="col-12">
                    ...
                    <template v-if="props.row.user_id?.email">
                      ...
                      <a :href="'mailto:' + props.row.user_id.email" class="text-primary text-caption">{{
                        props.row.user_id.email
                      }}</a>
                  ...
                  <div class="col-6">
                    ...
                    <div>
                      <a
                        ...
                        :href="'tel:' + props.row.Numero_di_cellulare"
                        class="text-primary"
                        >{{ props.row.Numero_di_cellulare }}</a
                      ><span v-else class="text-grey-5">—</span>
                    </div>
                  </div>
                  <div class="col-6">
                    ...
                    <div>
                      <a
                        ...
                        :href="'tel:' + props.row.Numero_di_telefono"
                        class="text-primary"
                        >{{ props.row.Numero_di_telefono }}</a
                      ><span v-else class="text-grey-5">—</span>
                    </div>
                  </div>
                  <div class="col-12">
      ...
      <template #body-cell-cellulare="props">
        <q-td :props="props">
          <a v-if="props.row.Numero_di_cellulare" :href="'tel:' + props.row.Numero_di_cellulare" class="text-primary">{{
      ...
      <template #body-cell-telefono="props">
        <q-td :props="props">
          <a v-if="props.row.Numero_di_telefono" :href="'tel:' + props.row.Numero_di_telefono" class="text-primary">{{
