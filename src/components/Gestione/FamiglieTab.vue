<template>
  <div>
                      ...
                      <q-item-section>
                        ...
                        <q-item-label caption lines="1">
                          <template v-for="em in c._emails" :key="em.email_address">
                            <q-icon name="email" size="xs" class="q-mr-xs" /><a
        ...
        <q-tr :props="props">
          ...
          <q-td v-for="col in props.cols" :key="col.name" :props="props">
            ...
            <template v-else-if="col.name === 'azioni'">
              ...
              <q-btn flat dense icon="contacts" aria-label="Gestisci contatti" @click="openContatti(props.row)">
                <q-tooltip>Gestisci contatti</q-tooltip>
              </q-btn>
            </template>
            <template v-else>
                        ...
                        <q-item-label caption lines="1">
                          ...
                          <template v-if="c.Contatto?.Numero_di_cellulare">
                            <span class="q-ml-sm">
                              ...
                              <a :href="'tel:' + c.Contatto.Numero_di_cellulare" class="text-primary">{{
                          ...
                          <template v-if="c.Contatto?.Numero_di_telefono">
                            <span class="q-ml-sm">
                              ...
                              <a :href="'tel:' + c.Contatto.Numero_di_telefono" class="text-primary">{{
    ...
    <ContattiDialog v-model="showContatti" :famiglia="contattiTarget" />
  </div>
</template>
